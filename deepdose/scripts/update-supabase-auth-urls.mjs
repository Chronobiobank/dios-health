...
const body = {
  site_url: 'https://www.unmed.net',
  uri_allow_list:
    'http://127.0.0.1:3000,http://127.0.0.1:3000/auth/callback,https://127.0.0.1:3000,https://www.unmed.net/auth/callback,https://unmed.net/auth/callback,https://www.deepdose.org/auth/callback,https://deepdose.org/auth/callback,https://*.vercel.app/auth/callback',
}
