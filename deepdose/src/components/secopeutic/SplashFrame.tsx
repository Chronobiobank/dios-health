...
import { SplashVideoBackground } from '@/components/secopeutic/SplashVideoBackground'
...
export function SplashFrame({ children }: { children: ReactNode }) {
  return (
    <div className="clinical-layout secopeutic-demo seco-shell--dark seco-splash">
