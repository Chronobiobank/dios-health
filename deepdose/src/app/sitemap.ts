...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/how`, lastModified, changeFrequency: 'monthly', priority: 0.95 },
    ...
    { url: `${BASE}/founders`, lastModified, changeFrequency: 'monthly', priority: 0.9 },
    { url: `${BASE}/founders/join`, lastModified, changeFrequency: 'monthly', priority: 0.85 },
    ...
    { url: `${BASE}/homekit`, lastModified, changeFrequency: 'monthly', priority: 0.85 },
    ...
    { url: `${BASE}/matches`, lastModified, changeFrequency: 'weekly', priority: 0.8 },
