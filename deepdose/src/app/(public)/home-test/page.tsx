      ...
      <div className="seco-landing__section-inner">
        <header className="seco-hometest__hero seco-reveal seco-reveal--1">
          <figure className="seco-hometest__hero-media">
            ...
            />
            <div className="seco-hometest__hero-overlay">
              <p className="seco-hometest__hero-eyebrow">TipTraQ home kit</p>
              <h1 className="seco-hometest__hero-title">Your home sleep test</h1>
            </div>
          </figure>
        </header>
        ...
        <section className="seco-hometest__section seco-reveal seco-reveal--3">
          <div className="seco-hometest__cols">
            <div className="seco-hometest__col">
              <header className="seco-hometest__col-head">
                <h2 className="seco-hometest__col-title">What&rsquo;s in the kit</h2>
              </header>
            ...
            <div className="seco-hometest__col">
              <header className="seco-hometest__col-head">
                <h2 className="seco-hometest__col-title">What you get</h2>
              </header>
              <div className="seco-hometest__panel">
                <ul className="seco-hometest__checklist">
                  {BENEFITS.map((item) => (
