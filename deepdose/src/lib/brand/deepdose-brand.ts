...
/** Core user promise — chronotype discovery + tribe. */
export const DEEPDOSE_PROMISE =
  'Discover your chemical chronotype. Find your people.' as const
...
export const DEEPDOSE_POSITIONING =
  'Deepdose is the first social network designed around chemical chronotypes and human connection.' as const
...
export const DEEPDOSE_NORTH_STAR =
  'Meaningful Syncs Created — people who discover someone who matches their chemical chronotype and form a real connection.' as const
...
/**
 * Copy hierarchy:
 * Positioning = first social network for chemical chronotypes + connection.
 ...
 * Discover your chemical chronotype. Find your people. = core promise.
