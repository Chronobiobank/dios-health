...
export const SPECTRUM_NODES: SpectrumNodeSpec[] = [
  {
    ...
    layer1Signal: 'MLux phase time from Vaya camera session',
  ...
  },
  {
    ...
    layer1Signal: 'Nocturnal MLux adequacy from Vaya session',
    layer2Signal:
  ...
  },
  {
    ...
    layer1Signal: 'Chronotype + morning MLux adequacy from Vaya',
  ...
  },
  {
    ...
    layer1Signal: 'Evening chronotype flag from Vaya + MLux phase time',
  ...
  },
  {
    ...
    layer1Signal:
      'Morning MLux adequacy (UVB proxy) + melanin calibration from Vaya',
  ...
  },
  {
    ...
    layer1Signal: 'Phase delay + evening light exposure from Vaya session',
  ...
  },
  {
    ...
    layer1Signal: 'Nocturnal light exposure score from Vaya — night-shift flag',
