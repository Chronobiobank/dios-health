...
export const SPECTRUM_NODES: SpectrumNodeSpec[] = [
  {
    ...
    layer1Signal: 'MLux phase time from Mel camera session',
  ...
  },
  {
    ...
    layer1Signal: 'Nocturnal MLux adequacy from Mel session',
    layer2Signal:
  ...
  },
  {
    ...
    layer1Signal: 'Chronotype + morning MLux adequacy from Mel',
  ...
  },
  {
    ...
    layer1Signal: 'Evening chronotype flag from Mel + MLux phase time',
  ...
  },
  {
    ...
    layer1Signal:
      'Morning MLux adequacy (UVB proxy) + melanin calibration from Mel',
  ...
  },
  {
    ...
    layer1Signal: 'Phase delay + evening light exposure from Mel session',
  ...
  },
  {
    ...
    layer1Signal: 'Nocturnal light exposure score from Mel — night-shift flag',
