/** Founding mission — Chronobiobank recruitment and practitioner framing. */

export const CHRONOBIOBANK_FOUNDING_MISSION =
  'By pooling their data into a secure, user-owned chronobiobank, the patients themselves fund and create the largest clinical-grade study on high-dose therapy in human history.'

export const COIMBRA_PARADOX_STATEMENT = `Mainstream medicine requires clinical trial evidence for treatments it will endorse. Clinical trials for vitamin D are not funded because vitamin D cannot be patented. Ethics committees will not approve the doses without existing evidence. The evidence cannot be generated through conventional channels.

The Chronobiobank breaks this cycle entirely.
